	...
	return (
		<>
			<div className={style.agreement}>
				<h1>TÜKETİCİ HAKLARI – CAYMA – İPTAL İADE KOŞULLARI</h1>
				...
				<p>
					...
					yürürlükteki diğer yasalara tabidir. <br />
					...
					teslim edilmek zorundadır. <br />
					6. Satın alınan ürünün satılmasının imkansızlaşması durumunda, satıcı
				...
				<p>
					8. Ürün teslim edildikten sonra, alıcının ödeme yaptığı kredi kartının
				...
				<p>
					9. Satıcı’nın öngöremeyeceği mücbir sebepler oluşursa ve ürün
				...
				<p>
					...
					kullanılacaksa mal/hizmet kullanılmamalıdır. Ürünle birlikte Fatura da
					iade edilmelidir.
				</p>
				...
				<p>
					...
					hizmet sözleşmelerinde cayma hakkı kullanılamaz. <br />
					14. Cayma hakkının kullanımından kaynaklanan masraflar SATICI’ ya
					aittir. <br />
				...
				<p>
					16. 3. kişiye veya ALICI’ ya teslim edilen ürünün faturası, (İade
				...
				<p>
					18. SATICI, cayma bildiriminin kendisine ulaşmasından itibaren en geç
					...
					19. ALICI’ nın kusurundan kaynaklanan bir nedenle malın değerinde bir
					...
					gelen değişiklik ve bozulmalardan ALICI sorumlu değildir. <br />
					20. Cayma hakkının kullanılması nedeniyle SATICI tarafından düzenlenen
				...
				<p>
					21. ALICI’nın isteği veya açıkça kişisel ihtiyaçları doğrultusunda
					...
					kullanılması da Yönetmelik gereği mümkün değildir. <br />
				...
				<p>
					23. ALICI, ödeme işlemlerini kredi kartı ile yaptığı durumda temerrüde
				...
				<p>
					24. Sitemiz üzerinden kredi kartlarınız ile, Her türlü kredi kartınıza
