	...
	return (
		<>
			<div className={style.policy}>
				...
				<p>
					Liveme firmamızda verilen tüm servisler www.livemeshop.com adresinde
					kayıtlı ve firmamız tarafından işletilmektedir.
				</p>
				<p>
				...
				<p>
					...
					bilgileri(isim-soy isim, firma bilgileri, adres, telefon veya e-posta
					adresleri vb. gibi) Mağazamız tarafından iş gereği toplanılmaktadır.
				</p>

				<p>
					Liveme firmamız bazı dönemlerde müşterilerine kampanya bilgisi, yeni
					ürünler hakkında bilgi, promosyon teklifler gönderebilir. Üye bu
					bilgileri alıp almama konusunda üye olurken seçim yapabilir. Daha
					sonrasında tekrardan üyelik ayarları kısmından bunu düzenleyebilir.
				</p>
				<p>
					Liveme mağazamız üzerinden veya e-posta aracılığıyla gerçekleştirelen
					onay sürecinde, üyelerimiz tarafından mağazamıza elektronik ortamda
					iletilen kişisel bilgiler, üyelerimizle gerçekleştirdiğimiz ‘’
					Kullanıcı Sözleşmesi ‘’ ile belirlenen amaç ve kapsam dışında üçüncü
				...
				<p>
					Liveme firmamız, Üyelik sözleşmesi ile belirlenen amaçlar ve kapsam
					dışında da, talep edilen bilgileri kendisi veya işbirliği içinde
					bulunduğu kişiler tarafınca doğrudan pazarlama yapmak amacıyla
					kullanılabilmektedir. Kişisel bilgiler, gerektiğinde kullanıcıyla
					temas kurmak için de kullanılabilir. Firmamız tarafından talep edilen
					bilgiler veya kullanıcı tarafından sağlanan bilgiler veya Mağazamız
					üzerinden yapılan işlemlerle ilgili bilgiler; Firmamız ve işbirliği
					içinde olduğu kişiler tarafından, "Üyelik Sözleşmesi" ile belirlenen
				...
				<p>
					...
					müşterilerin siparişlerinin tedarik ve teslimat aşamasına gelebilmesi
					için öncelikle finansal ve adres/telefon bilgilerinin doğruluğunun
				...
				<p>
					...
					getirdiği zorunluluklara uymak; 2.Mağazamızın kullanıcılarla akdettiği
					"Üyelik Sözleşmesi"'nin ve diğer sözleşmelerin gereklerini yerine
					getirmek ve bunları uygulamaya koymak amacıyla; 3.Yetkili idari ve
					adli otorite tarafından usulüne göre yürütülen bir araştırma veya
					soruşturmanın yürütümü amacıyla kullanıcılarla ilgili bilgi talep
					edilmesi; 4.Kullanıcıların hakları veya güvenliklerini korumak için
				...
				<p>
					...
					adresine email gönderebilirsiniz. Firmamız’a ait aşağıdaki iletişim
