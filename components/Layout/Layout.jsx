...
import { Footer, Header, LoaderFullScreen, Mobilenavigate } from '../index'
...
import { setWish } from '@/slices/wishSlice'
	...
	React.useEffect(() => {
		if (!!loggedIn) {
			...
			window.navigator.geolocation.getCurrentPosition((position) => {
				...
				getCurrency(position.coords.latitude, position.coords.longitude).then(
					(current) => {
	...
	return (
		<>
			<Head>
				...
				<link
					href="https://fonts.googleapis.com/css2?family=Balsamiq+Sans:ital,wght@0,400;0,700;1,400;1,700&family=Caveat:wght@400;500;600;700&display=swap"
					rel="stylesheet"
				/>
